...
<main class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-hover">
        <thead><p><p><p><p>
             <tr>
                 <th width="36%" scope="col"><div align="left">Produto</th></div>
                 <th width="22%" scope="col">Valor</th>
                ...
                if(isset($_SESSION['shopping-cart'])){
                    ...
                    foreach($carrinho as $item){
                        echo "<tr>
                            ...
                            <td>R$ ".number_format($item->getProduto()->getValor())."</td>
                            <td>".$item->getQuantidade()."</td>
                            <td>R$ ".number_format($item->getQuantidade() * $item->getProduto()->getValor())."</td>
                        </tr>";
                    }{
                       echo"<tr>                                  
                            <td>TOTAL: R$ ".number_format($item->getProduto()->getValor() + $item->getProduto()->getValor())."</td>
